...
public class ClienteFormulario extends javax.swing.JInternalFrame {
    ...
    private void jbSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalirActionPerformed
        ...
        dispose();
        cl = null;//Se deja el objeto en condicion de ser eliminado al fin del prog.
    ...
    private void comprobarCamposAlGuardOModif(){
    ...
    private void comprobarCamposAlBuscar(){
